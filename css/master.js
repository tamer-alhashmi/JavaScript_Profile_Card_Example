...
proPic.src = "1627395228537 (2).jpg";
...
proPic.style.cssText =
  "filter: drop-shadow(2px 4px 6px #00000075); width: 140px; border-radius: 50%; position: absolute; top: -80px; transform: translate(-50%); border: 6px solid #0875cf60";
...
icon1.style.cssText = "text-shadow: 0px 2px 15px #00000075; color: #1877f2";
icon2.style.cssText = "text-shadow: 0px 2px 15px #00000075; color: #1da1f2";
icon3.style.cssText = "text-shadow: 0px 2px 15px #00000075; color: #333";
icon4.style.cssText = "text-shadow: 0px 2px 15px #00000075; color: #0077b5";
icon5.style.cssText = "text-shadow: 0px 2px 15px #00000075; color: #f67c1a";
icon6.style.cssText = "text-shadow: 0px 2px 15px #00000075; color: #333";
// Style End
